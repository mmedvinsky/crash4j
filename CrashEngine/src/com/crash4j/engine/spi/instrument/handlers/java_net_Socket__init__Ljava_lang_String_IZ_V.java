...
/**
 * Resource factory implementation for java.net.Socket#<init>(Ljava/lang/String;IZ)V
 */
public class java_net_Socket__init__Ljava_lang_String_IZ_V extends DefaultHandler implements ResourceBuilder
{
    @Override
    	...
    	throws UnknownResourceException, URISyntaxException
    {
        ...
        NetworkResourceSpiImpl r = new NetworkResourceSpiImpl(spec, (Socket)instance, host, port, null, 0);
