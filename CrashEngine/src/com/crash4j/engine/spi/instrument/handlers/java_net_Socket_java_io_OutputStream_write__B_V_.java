...
/**
 * Resource factory implementation for java.net.Socket!java.io.OutputStream#write([B)V;
 */
public class java_net_Socket_java_io_OutputStream_write__B_V_ extends DefaultHandler implements ResourceBuilder
{
    @Override
    ...
    public void exit(ResourceSpi spi, ResourceSpec spec, Object args, Object instance, Object rv, ResourceClosure c, Object ex, long testStartTime, long actualDt, long dt)
    {
		...
		{
			ResourceManagerSpi.raiseProtocolEvent(pr.afterWrite(spi, b, 0, b.length, b.length));
		}
    }
			...
			Object instance, Object rv, ResourceClosure c) 
	{
        ...
        byte[] b = (byte[])ArrayUtil.get(args,  0);
        ResourceManagerSpi.raiseProtocolEvent(pr.beforeWrite(spi, b, 0, b.length));
	}
