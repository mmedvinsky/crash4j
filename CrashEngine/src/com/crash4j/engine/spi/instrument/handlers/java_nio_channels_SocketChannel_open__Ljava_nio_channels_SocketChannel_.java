...
/**
 * Resource factory implementation for $class#java.nio.channels.SocketChannel#open()Ljava/nio/channels/SocketChannel;
 */
public class java_nio_channels_SocketChannel_open__Ljava_nio_channels_SocketChannel_ extends DefaultHandler implements ResourceBuilder, FacadeBuilder
{
    @Override
