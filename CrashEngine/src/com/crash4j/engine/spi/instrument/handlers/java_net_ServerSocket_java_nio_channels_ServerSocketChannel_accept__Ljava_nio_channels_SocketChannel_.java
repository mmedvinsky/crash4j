...
/**
 * Resource factory implementation for $class#java.nio.channels.ServerSocketChannel#accept()Ljava/nio/channels/SocketChannel;
 */
public class java_net_ServerSocket_java_nio_channels_ServerSocketChannel_accept__Ljava_nio_channels_SocketChannel_ 
extends DefaultHandler implements ResourceBuilder, FacadeBuilder
{
    @Override
