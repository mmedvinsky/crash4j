...
/**
 * Resource factory implementation throughput support with number of bytes as an Integer 
 */
public abstract class any_Throughput_Integer extends DefaultHandler implements ResourceBuilder
{
    /**
    ...
    public void exit(ResourceSpi spi, ResourceSpec spec, Object args, Object instance, Object rv, ResourceClosure c, Object ex, long testStartTime, long actualDt, long dt)
    {
        ...
        sMgr.submit(spi, StatTypes.THROUGHPUT, UnitTypes.MICROSECONDS, action, dt, (Integer)rv);
    }
}
