...
/**
 * Resource factory implementation for $class#java.nio.channels.DatagramChannel#write(Ljava/nio/ByteBuffer;)I
 */
public class java_net_DatagramSocket_java_nio_channels_DatagramChannel_write_Ljava_nio_ByteBuffer__I extends any_Throughput_Integer implements ResourceBuilder
{
    @Override
