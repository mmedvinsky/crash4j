...
/**
 * Resource factory implementation for java.net.Socket#<init>(Ljava/net/InetAddress;ILjava/net/InetAddress;I)V
 */
public class java_net_Socket__init__Ljava_net_InetAddress_ILjava_net_InetAddress_I_V extends DefaultHandler implements ResourceBuilder
{
    @Override
    	...
    	throws UnknownResourceException, URISyntaxException
    {
        ...
        NetworkResourceSpiImpl r = new NetworkResourceSpiImpl(spec, (Socket)instance, host.getHostName(), port, lhost.getHostName(), lport);
