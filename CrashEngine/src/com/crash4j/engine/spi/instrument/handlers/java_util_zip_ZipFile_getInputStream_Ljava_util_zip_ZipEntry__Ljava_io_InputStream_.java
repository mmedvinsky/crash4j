...
/**
 * Resource factory implementation for java.util.zip.ZipFile#getInputStream(Ljava/util/zip/ZipEntry;)Ljava/io/InputStream;
 */
public class java_util_zip_ZipFile_getInputStream_Ljava_util_zip_ZipEntry__Ljava_io_InputStream_ extends DefaultHandler 
implements ResourceBuilder, FacadeBuilder
{
    ...
    {
    	ZipFile zf = (ZipFile)instance;
        return new FilesystemResourceSpiImpl(spec, zf.getName());
    }
    @Override
