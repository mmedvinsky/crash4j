...
/**
 * Resource factory implementation for java.net.Socket!java.nio.channels.SocketChannel#write(Ljava/nio/ByteBuffer;)I
 */
public class java_net_Socket_java_nio_channels_SocketChannel_write_Ljava_nio_ByteBuffer__I extends any_Throughput_Integer implements ResourceBuilder
{
    @Override
