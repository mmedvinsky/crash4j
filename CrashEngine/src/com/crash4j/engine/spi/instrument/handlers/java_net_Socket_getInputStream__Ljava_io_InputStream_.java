...
/**
 * Resource factory implementation for java.net.Socket#getInputStream()Ljava/io/InputStream;
 */
public class java_net_Socket_getInputStream__Ljava_io_InputStream_ extends DefaultHandler implements ResourceBuilder, FacadeBuilder
{
    @Override
