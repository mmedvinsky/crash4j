...
/**
 * Resource factory implementation for java.net.Socket#connect(Ljava/net/SocketAddress;)V
 */
public class java_net_Socket_connect_Ljava_net_SocketAddress__V extends DefaultHandler implements ResourceBuilder
{
    @Override
