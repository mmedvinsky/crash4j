...
/**
 * Resource factory implementation for $class#java.nio.channels.DatagramChannel#read(Ljava/nio/ByteBuffer;)I
 */
public class java_net_DatagramSocket_java_nio_channels_DatagramChannel_read_Ljava_nio_ByteBuffer__I extends any_Throughput_Integer implements ResourceBuilder
{
    @Override
