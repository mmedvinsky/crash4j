 ...
 */
public class java_net_Socket__init__Ljava_net_SocketImpl__V extends DefaultHandler implements ResourceBuilder
{
    @Override
    ...
    {
        NetworkResourceSpiImpl r = new  NetworkResourceSpiImpl(spec, (Socket)instance);
