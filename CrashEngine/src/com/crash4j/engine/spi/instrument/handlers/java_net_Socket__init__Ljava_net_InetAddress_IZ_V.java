...
/**
 * Resource factory implementation for java.net.Socket#<init>(Ljava/net/InetAddress;IZ)V
 */
public class java_net_Socket__init__Ljava_net_InetAddress_IZ_V extends DefaultHandler implements ResourceBuilder
{
    @Override
