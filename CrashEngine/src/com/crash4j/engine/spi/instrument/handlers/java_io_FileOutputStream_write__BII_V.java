...
/**
 * Resource factory implementation for java.io.FileOutputStream#write([BII)V
 */
public class java_io_FileOutputStream_write__BII_V extends DefaultHandler implements ResourceBuilder
{
    @Override
    ...
    public void exit(ResourceSpi spi, ResourceSpec spec, Object args, Object instance, Object rv, ResourceClosure c, Object ex, long testStartTime, long actualDt, long dt)
    {
        ...
        int b = ArrayUtil.getInt(args,  2);
        sMgr.submit(spi, StatTypes.THROUGHPUT, UnitTypes.MICROSECONDS, action, dt, b);
    }
}
