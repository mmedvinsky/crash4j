...
/**
 * Resource factory implementation for $class#java.nio.channels.DatagramChannel#read([Ljava/nio/ByteBuffer;II)J
 */
public class java_net_DatagramSocket_java_nio_channels_DatagramChannel_read__Ljava_nio_ByteBuffer_II_J extends any_Throughput_Long implements ResourceBuilder
{
    @Override
