...
/**
 * Resource factory implementation for java.net.DatagramSocket#send(Ljava/net/DatagramPacket;)V
 */
public class java_net_DatagramSocket_send_Ljava_net_DatagramPacket__V extends DefaultHandler implements ResourceBuilder
{
    @Override
    	...
    	throws UnknownResourceException, URISyntaxException
    {
        ...
        return new NetworkResourceSpiImpl(spec, (DatagramSocket)instance, packet, null, true);
    }
    /**
