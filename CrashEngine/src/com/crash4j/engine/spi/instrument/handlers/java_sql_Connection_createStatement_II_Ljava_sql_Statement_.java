...
/**
 * Resource factory implementation for java.sql.Connection#createStatement(II)Ljava/sql/Statement;
 */
public class java_sql_Connection_createStatement_II_Ljava_sql_Statement_ extends java_sql_Base 
