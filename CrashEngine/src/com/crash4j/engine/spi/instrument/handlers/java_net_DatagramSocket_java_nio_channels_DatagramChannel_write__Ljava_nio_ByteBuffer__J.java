...
/**
 * Resource factory implementation for $class#java.nio.channels.DatagramChannel#write([Ljava/nio/ByteBuffer;)J
 */
public class java_net_DatagramSocket_java_nio_channels_DatagramChannel_write__Ljava_nio_ByteBuffer__J extends any_Throughput_Long implements ResourceBuilder
{
    @Override
