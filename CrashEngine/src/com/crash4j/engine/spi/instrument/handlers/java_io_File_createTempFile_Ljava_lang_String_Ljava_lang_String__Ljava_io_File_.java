...
/**
 * Resource factory implementation for java.io.File#createTempFile(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;
 */
public class java_io_File_createTempFile_Ljava_lang_String_Ljava_lang_String__Ljava_io_File_ extends DefaultHandler implements ResourceBuilder
{
    	...
    	throws UnknownResourceException, URISyntaxException
    {
        if (rv != null)
        {
            return new FilesystemResourceSpiImpl(spec, (File)rv);        
        }
