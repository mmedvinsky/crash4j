...
/**
 * Resource factory implementation for java.net.Socket#<init>(Ljava/lang/String;I)V
 */
public class java_net_Socket__init__Ljava_lang_String_I_V extends DefaultHandler implements ResourceBuilder
{
    @Override
    	...
    	throws UnknownResourceException, URISyntaxException
    {
        ...
        int lport = ((Socket)instance).getLocalPort();
        InetAddress add = ((Socket)instance).getLocalAddress();
        
        NetworkResourceSpiImpl r = new NetworkResourceSpiImpl(spec, (Socket)instance, host, port, add.getHostName(), lport);
