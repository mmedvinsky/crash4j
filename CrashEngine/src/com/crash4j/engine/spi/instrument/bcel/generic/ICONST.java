...
public class ICONST extends Instruction implements ConstantPushInstruction {
    ...
    public ICONST(int i) {
        super(com.crash4j.engine.spi.instrument.bcel.Constants.ICONST_0, (short) 1);
        if ((i >= -1) && (i <= 5)) {
            opcode = (short) (com.crash4j.engine.spi.instrument.bcel.Constants.ICONST_0 + i); // Even works for i == -1
        } else {
