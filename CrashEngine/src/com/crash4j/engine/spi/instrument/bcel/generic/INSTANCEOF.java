...
public class INSTANCEOF extends CPInstruction implements LoadClass, ExceptionThrower,
    ...
    public INSTANCEOF(int index) {
        super(com.crash4j.engine.spi.instrument.bcel.Constants.INSTANCEOF, index);
    }


    public Class<?>[] getExceptions() {
        return com.crash4j.engine.spi.instrument.bcel.ExceptionConstants.EXCS_CLASS_AND_INTERFACE_RESOLUTION;
    }
