...
public class LCONST extends Instruction implements ConstantPushInstruction, TypedInstruction {
    ...
    public LCONST(long l) {
        super(com.crash4j.engine.spi.instrument.bcel.Constants.LCONST_0, (short) 1);
        if (l == 0) {
            opcode = com.crash4j.engine.spi.instrument.bcel.Constants.LCONST_0;
        } else if (l == 1) {
            opcode = com.crash4j.engine.spi.instrument.bcel.Constants.LCONST_1;
        } else {
