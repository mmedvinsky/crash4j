...
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantDouble;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantFieldref;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantFloat;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantInteger;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantInterfaceMethodref;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantLong;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantMethodref;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantNameAndType;
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantString;
...
import com.crash4j.engine.spi.instrument.bcel.classfile.LineNumber;
...
import com.crash4j.engine.spi.instrument.bcel.generic.ALOAD;
import com.crash4j.engine.spi.instrument.bcel.generic.ANEWARRAY;
import com.crash4j.engine.spi.instrument.bcel.generic.ASTORE;
...
import com.crash4j.engine.spi.instrument.bcel.generic.BREAKPOINT;
...
import com.crash4j.engine.spi.instrument.bcel.generic.DLOAD;
import com.crash4j.engine.spi.instrument.bcel.generic.DSTORE;
import com.crash4j.engine.spi.instrument.bcel.generic.FLOAD;
import com.crash4j.engine.spi.instrument.bcel.generic.FSTORE;
import com.crash4j.engine.spi.instrument.bcel.generic.FieldInstruction;
import com.crash4j.engine.spi.instrument.bcel.generic.GETSTATIC;
import com.crash4j.engine.spi.instrument.bcel.generic.GotoInstruction;
import com.crash4j.engine.spi.instrument.bcel.generic.IINC;
import com.crash4j.engine.spi.instrument.bcel.generic.ILOAD;
import com.crash4j.engine.spi.instrument.bcel.generic.IMPDEP1;
import com.crash4j.engine.spi.instrument.bcel.generic.IMPDEP2;
import com.crash4j.engine.spi.instrument.bcel.generic.INSTANCEOF;
import com.crash4j.engine.spi.instrument.bcel.generic.INVOKEINTERFACE;
import com.crash4j.engine.spi.instrument.bcel.generic.INVOKESPECIAL;
import com.crash4j.engine.spi.instrument.bcel.generic.INVOKESTATIC;
import com.crash4j.engine.spi.instrument.bcel.generic.INVOKEVIRTUAL;
import com.crash4j.engine.spi.instrument.bcel.generic.ISTORE;
...
import com.crash4j.engine.spi.instrument.bcel.generic.JsrInstruction;
import com.crash4j.engine.spi.instrument.bcel.generic.LDC;
import com.crash4j.engine.spi.instrument.bcel.generic.LDC2_W;
import com.crash4j.engine.spi.instrument.bcel.generic.LLOAD;
import com.crash4j.engine.spi.instrument.bcel.generic.LOOKUPSWITCH;
import com.crash4j.engine.spi.instrument.bcel.generic.LSTORE;
import com.crash4j.engine.spi.instrument.bcel.generic.LoadClass;
import com.crash4j.engine.spi.instrument.bcel.generic.MULTIANEWARRAY;
import com.crash4j.engine.spi.instrument.bcel.generic.NEW;
...
import com.crash4j.engine.spi.instrument.bcel.generic.PUTSTATIC;
...
import com.crash4j.engine.spi.instrument.bcel.generic.TABLESWITCH;
...
public final class Pass3aVerifier extends PassVerifier{
	 ...
	 */
	private class InstOperandConstraintVisitor extends com.crash4j.engine.spi.instrument.bcel.generic.EmptyVisitor{
