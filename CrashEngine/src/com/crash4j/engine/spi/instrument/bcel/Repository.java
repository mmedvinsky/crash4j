 ...
 *
 */
package com.crash4j.engine.spi.instrument.bcel;

import java.io.IOException;

import com.crash4j.engine.spi.instrument.bcel.classfile.JavaClass;
import com.crash4j.engine.spi.instrument.bcel.util.ClassPath;
import com.crash4j.engine.spi.instrument.bcel.util.SyntheticRepository;
...
public abstract class Repository {
    ...
    private static com.crash4j.engine.spi.instrument.bcel.util.Repository _repository = SyntheticRepository.getInstance();


    /** @return currently used repository instance
     */
    public static com.crash4j.engine.spi.instrument.bcel.util.Repository getRepository() {
        return _repository;
    }
     ...
     */
    public static void setRepository( com.crash4j.engine.spi.instrument.bcel.util.Repository rep ) {
        _repository = rep;
    }
