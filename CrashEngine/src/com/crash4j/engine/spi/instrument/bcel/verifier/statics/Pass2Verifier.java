...
import com.crash4j.engine.spi.instrument.bcel.classfile.ConstantValue;
import com.crash4j.engine.spi.instrument.bcel.classfile.Deprecated;
import com.crash4j.engine.spi.instrument.bcel.classfile.DescendingVisitor;
import com.crash4j.engine.spi.instrument.bcel.classfile.EmptyVisitor;
import com.crash4j.engine.spi.instrument.bcel.classfile.ExceptionTable;
import com.crash4j.engine.spi.instrument.bcel.classfile.Field;
import com.crash4j.engine.spi.instrument.bcel.classfile.InnerClass;
import com.crash4j.engine.spi.instrument.bcel.classfile.InnerClasses;
 ...
 *
 * @version $Id: Pass2Verifier.java 1554576 2013-12-31 22:05:01Z ggregory $
 * @author Enver Haase
 * @see #do_verify()
 */
public final class Pass2Verifier extends PassVerifier implements Constants{
	 ...
	 *
	 * @see com.crash4j.engine.spi.instrument.bcel.verifier.statics.Pass3aVerifier
	 */
	@Override
   ...
   * @see #constant_pool_entries_satisfy_static_constraints()
	 */
	private class CPESSC_Visitor extends com.crash4j.engine.spi.instrument.bcel.classfile.EmptyVisitor{
        ...
        */
		...
		private CPESSC_Visitor(JavaClass _jc){
			...
			CONST_Class = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantClass.class;
			/*
            ...
            */
			CONST_String = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantString.class;
			CONST_Integer = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantInteger.class;
			CONST_Float = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantFloat.class;
			CONST_Long = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantLong.class;
			CONST_Double = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantDouble.class;
			CONST_NameAndType = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantNameAndType.class;
			CONST_Utf8 = com.crash4j.engine.spi.instrument.bcel.classfile.ConstantUtf8.class;
   ...
   * pool must be valid.</B>
	 *
   * @see #constant_pool_entries_satisfy_static_constraints()
	 * @see com.crash4j.engine.spi.instrument.bcel.classfile.ConstantCP
	 */
