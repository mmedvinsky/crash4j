...
public abstract class CPInstruction extends Instruction implements TypedInstruction,
    ...
    public String toString( ConstantPool cp ) {
        ...
        return com.crash4j.engine.spi.instrument.bcel.Constants.OPCODE_NAMES[opcode] + " " + str;
    }
    ...
    public Type getType( ConstantPoolGen cpg ) {
        ...
        String name = cp.getConstantString(index, com.crash4j.engine.spi.instrument.bcel.Constants.CONSTANT_Class);
        if (!name.startsWith("[")) {
            name = "L" + name + ";";
        }
