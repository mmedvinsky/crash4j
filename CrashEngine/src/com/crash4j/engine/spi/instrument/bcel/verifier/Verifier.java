...
import com.crash4j.engine.spi.instrument.bcel.verifier.statics.Pass1Verifier;
import com.crash4j.engine.spi.instrument.bcel.verifier.statics.Pass2Verifier;
import com.crash4j.engine.spi.instrument.bcel.verifier.statics.Pass3aVerifier;
import com.crash4j.engine.spi.instrument.bcel.verifier.structurals.Pass3bVerifier;
 ...
 *
 * @version $Id: Verifier.java 1554576 2013-12-31 22:05:01Z ggregory $
 * @author Enver Haase
 * @see com.crash4j.engine.spi.instrument.bcel.verifier.VerifierFactory
 * @see com.crash4j.engine.spi.instrument.bcel.verifier.PassVerifier
 */
        ...
        for (Pass3aVerifier pv : p3avs.values()) {
            ...
            for (String element : p3am) {
                messages.add("Pass 3a, method " + meth + " ('"
                        + com.crash4j.engine.spi.instrument.bcel.Repository.lookupClass(classname).getMethods()[meth]
                        + "'): " + element);
            }
        }
        ...
        for (int k = 0; k < args.length; k++) {
            try {
                ...
                if (vr == VerificationResult.VR_OK) {
                    JavaClass jc = com.crash4j.engine.spi.instrument.bcel.Repository.lookupClass(args[k]);
                ...
                // avoid swapping.
                v.flush();
                com.crash4j.engine.spi.instrument.bcel.Repository.clearCache();
                System.gc();
