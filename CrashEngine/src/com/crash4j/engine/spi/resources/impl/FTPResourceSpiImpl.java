...
/**
 * Describes ftp resource
 * @see ResourceSpi
 */
public class FTPResourceSpiImpl extends EndpointBasedResourceSpiImpl
{
	/**
	 * SMTP resource desc
	 * @param spec
	 ...
	 */
	public FTPResourceSpiImpl(ResourceSpec spec, InetAddress host, int port)
			throws MalformedURLException 
	{
